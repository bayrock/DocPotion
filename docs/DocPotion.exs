defmodule DocPotion do
    ...
    def _alchemy({filename, layout}) do
        ...
        {String.replace(filename, ".layout", ""), Regex.replace(pattern, layout, fn _, partial -> File.read!("partials/#{partial}.md") end)}
    end

    def _write({docname, content}) do
        root = ".." # The directory to write documents to
        watermark = "\n\n<!-- This file was generated by DocPotion -->\n"
        File.write!("#{root}/#{docname}", "#{content}#{watermark}")
    end
    ...
    def error(), do: raise "Error running #{__MODULE__}!"
end
